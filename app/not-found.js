    ...
    return ( 
        <div className="min-h-screen flex flex-col">
            ...
            <div className="flex flex-col items-center justify-center flex-grow space-y-6 text-center px-4 mb-4">
                ...
                <Link 
                    href="/" 
                    className="bg-red_reign hover:bg-red_republic text-white font-semibold py-2 px-4 rounded-lg transition duration-300 ease-in-out shadow-md hover:shadow-lg"
                >
                    Return to Home
                </Link>
            </div>
