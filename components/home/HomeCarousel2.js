...
const HomeCarousel2 = () => {
  ...
  return (
    <div ref={wrapperRef} className="relative " style={{ height: `${wrapperHeight}px` }}>
      <div className="sticky h-screen overflow-hidden w-full bg-green-500">
        <h2 className="my-4 2xl:py-8 md:my-6 mx-6 md:mx-14 text-medium leading-11 md:text-large font-semibold text-red_republic font-almarena-semibold 2xl:text-huge">
